...
export const scheduleArray = [
  {
    ...
    option: [
      ...
      { id: 3, name: "Monday", time: "11" },
      { id: 4, name: "Monday", time: "12" },
      { id: 5, name: "Monday", time: " 1" },
      { id: 6, name: "Monday", time: "2" },
      { id: 7, name: "Monday", time: "3" },
      { id: 8, name: "Monday", time: "4" },
      { id: 9, name: "Monday", time: "5" },
    ],
  },
  {
    id: 2,
    name: "Tuesday",
    option: [
      { id: 10, name: "Tuesday", time: "9" },
      { id: 11, name: "Tuesday", time: "10" },
      { id: 12, name: "Tuesday", time: "11" },
      { id: 13, name: "Tuesday", time: "12" },
      { id: 14, name: "Tuesday", time: " 1" },
      { id: 15, name: "Tuesday", time: "2" },
      { id: 16, name: "Tuesday", time: "3" },
      { id: 17, name: "Tuesday", time: "4" },
      { id: 18, name: "Tuesday", time: "5" },
    ],
  },
  {
    id: 3,
    name: "Wednesday",
    option: [
      { id: 19, name: "Wednesday", time: "9" },
      { id: 20, name: "Wednesday", time: "10" },
      { id: 21, name: "Wednesday", time: "11" },
      { id: 22, name: "Wednesday", time: "12" },
      { id: 23, name: "Wednesday", time: " 1" },
      { id: 24, name: "Wednesday", time: "2" },
      { id: 25, name: "Wednesday", time: "3" },
      { id: 26, name: "Wednesday", time: "4" },
      { id: 27, name: "Wednesday", time: "5" },
    ],
  },
  {
    id: 4,
    name: "Thursday",
    option: [
      { id: 28, name: "Thursday", time: "9" },
      { id: 29, name: "Thursday", time: "10" },
      { id: 30, name: "Thursday", time: "11" },
      { id: 31, name: "Thursday", time: "12" },
      { id: 32, name: "Thursday", time: " 1" },
      { id: 33, name: "Thursday", time: "2" },
      { id: 34, name: "Thursday", time: "3" },
      { id: 35, name: "Thursday", time: "4" },
      { id: 36, name: "Thursday", time: "5" },
    ],
  },
  {
    id: 5,
    name: "Friday",
    option: [
      { id: 37, name: "Friday", time: "9" },
      { id: 38, name: "Friday", time: "10" },
      { id: 39, name: "Friday", time: "11" },
      { id: 40, name: "Friday", time: "12" },
      { id: 41, name: "Friday", time: " 1" },
      { id: 42, name: "Friday", time: "2" },
      { id: 43, name: "Friday", time: "3" },
      { id: 44, name: "Friday", time: "4" },
      { id: 45, name: "Friday", time: "5" },
    ],
  },
  {
    id: 6,
    name: "Saturday",
    option: [
      { id: 46, name: "Saturday", time: "9" },
      { id: 47, name: "Saturday", time: "10" },
      { id: 48, name: "Saturday", time: "11" },
      { id: 49, name: "Saturday", time: "12" },
      { id: 50, name: "Saturday", time: " 1" },
      { id: 51, name: "Saturday", time: "2" },
      { id: 52, name: "Saturday", time: "3" },
      { id: 53, name: "Saturday", time: "4" },
      { id: 54, name: "Saturday", time: "5" },
    ],
  },
];
